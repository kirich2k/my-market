...
const ItemsEarring: React.FC<ItemsEarringProps> = ({id,img,name,price}) => {
...
function Earring() {
    ...
    const fetchEarring = () => {
        ...
        axios
            .get(
                `https://62828536ed9edf7bd885eeb4.mockapi.io/items/earrings?${categoryId}${search}${priceSorting}`
            )
            .then((res) => {
                setItems(res.data);
                setLoad(true);
